...
def main():
    ...
    oracle_params = [
        # base tokens
        [Tokens.weth, [12616, 7927, 12500]],
        [Tokens.dai, [10525, 9502, 12500]],
        [Tokens.usdc, [10525, 9502, 12500]],
        [Tokens.usdt, [10525, 9502, 12500]],
        [Tokens.dpi, [14886, 6718, 12500]],
        [Tokens.yfi, [13681, 7309, 12500]],
        [Tokens.perp, [14886, 6718, 12500]],
        [Tokens.snx, [13681, 7309, 12500]],
        [Tokens.susd, [11660, 8576, 12500]],
        [Tokens.uni, [14886, 6718, 12500]],
        [Tokens.sushi, [14886, 6718, 12500]],
        # lp tokens
        [Tokens.uni_eth_dpi, [14886, 6718, 12500]],
        [Tokens.uni_eth_yfi, [13681, 7309, 12500]],
        [Tokens.uni_eth_snx, [13681, 7309, 12500]],
        [Tokens.uni_eth_susd, [12616, 7927, 12500]],
        [Tokens.uni_eth_uni, [14886, 6718, 12500]],
        [Tokens.sushi_eth_dpi, [14886, 6718, 12500]],
        [Tokens.sushi_eth_yfi, [13681, 7309, 12500]],
        [Tokens.sushi_eth_snx, [13681, 7309, 12500]],
        [Tokens.sushi_eth_susd, [12616, 7927, 12500]],
        [Tokens.sushi_eth_sushi, [14886, 6718, 12500]],
        [Tokens.bal_perp_usdc, [14886, 6718, 12500]],
        [Tokens.crv_3pool, [10525, 9502, 12500]],
        [Tokens.crv_susd, [11660, 8576, 12500]],
    ]
