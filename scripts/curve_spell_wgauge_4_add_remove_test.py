...
def main():
    ...
    ydai = interface.IERC20Ex('0x16de59092dae5ccf4a1e6439d611fd0653f0bd01')
    yusdc = interface.IERC20Ex('0x597ad1e0c13bfe8025993d9e79c69e1c0233522e')
    yusdt = interface.IERC20Ex('0xa1787206d5b1be0f432c4c4f96dc4d1257a1dd14')
    ...
    simple_oracle.setETHPx([dai, usdt, usdc, susd, ydai, yusdc, yusdt, ybusd],
                           [2**112 // 700, 2**112 // 700, 2**112 // 700, 2**112 // 700, 2**112 // 700, 2**112 // 700, 2**112 // 700, 2**112 // 700])
