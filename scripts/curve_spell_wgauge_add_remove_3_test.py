...
def main():
    ...
    receivedCrvFromStaking = crv.balanceOf(bob) - prevCrv
    print('receivedCrvFromStaking', receivedCrvFromStaking)
    assert almostEqual(receivedCrv, receivedCrvFromStaking)
